...
Hundreds of millions of freelancers globally, proven willingness to pay by adjacent tools (Bonsai/HoneyBook: 500K+ freelancers), and a horizontal problem — scope creep looks the same in Karachi, Manila, São Paulo, or Berlin. Full sizing and go-to-market pricing ($10/mo freelancer, $49/mo team) are in [`BUSINESS_CASE.md`](./BUSINESS_CASE.md).
